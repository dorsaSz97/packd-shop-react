...
const Header = () => {
  ...
  return (
    <Fragment>
      ...
      <nav className="h-[4.5rem] z-[100] fixed top-0 right-0 left-0 flex justify-between items-center py-5 px-7 bg-[#FEF9EF] text-lg shadow-xl  border-b-2 border-black">
